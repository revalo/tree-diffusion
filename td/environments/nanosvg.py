...
class NSVGToIceberg(Transformer):
    def __init__(
        self,
    ...
    def rect(self, meta, children):
        fill_color, stroke_color = children
...
class NSVGCompiler(Compiler):
    def __init__(self) -> None:
        super().__init__()
        self._expression_to_iceberg = NSVGToIceberg()
